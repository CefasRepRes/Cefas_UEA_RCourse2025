...
You can install the latest released version of *terra* from CRAN with `install.packages("terra")`. The development version is available from [github](https://www.github.com/rspatial/terra), and see the instructions there for installation. The [github](https://www.github.com/rspatial/terra) is a good place to report what you believe to be bugs (errors in the software) or to request new features. You can ask questions on how to use `terra` on [stackoverflow](https://stackoverflow.com/search?tab=newest&q=terra). 
...
You need to know some of the basics of the *R* language before you can work with *spatial data* in *R*. 
