...
![](C:/Users/ellie/OneDrive%20-%20University%20of%20East%20Anglia/!PhD/R%20course/R-code-headings.JPG)
...
``` r
df3 = data.frame(X = sample(1:3, 15, replace = TRUE)) # this generates 15 numbers randomly sampled, with replacement, from the numbers 1, 2, 3
...
You can also specify the mean and standard deviation of sampled data,
eg. using rnorm
