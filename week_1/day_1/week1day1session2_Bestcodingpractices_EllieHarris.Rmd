...
The following code and examples are from Hadley Wickham's tidyverse style guide.
...
chunks. This will also create subheadings that help to navigate to precise
points in your code.
...
# Plot data ---------------------------
```
![](C:/Users/ellie/OneDrive - University of East Anglia/!PhD/R course/R-code-headings.JPG)
...
start-up file, such as `.Rprofile`.
...
You can also specify generate numbers using mean and standard deviations of sampled data, eg. using rnorm
