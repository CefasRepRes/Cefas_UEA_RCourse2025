...
To use ggplot Theme Assist, you need to have the code for at least a basic graph. Highlight the code, go to 'addins' (just below the help button on the toolbar), and click **ggplot Theme Assist**. 
...
# either highlight plot code or assign the plot and use ggThemeAssistGadget()
...
It is possible to create interactive plots using packages such as `plotly`. This is a whole universe in its own which we won't go into in any detail, but you can just pass a ggplot object to plotly
...
We can use ggplot to create maps
...
An alternative package for maps is leaflet. This can be used to create interactive maps.
